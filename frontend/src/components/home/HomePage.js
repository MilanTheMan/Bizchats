        ...
        <div className="h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-100 to-gray-300">
            <main className="text-center w-full max-w-4xl px-6">
                ...
                <div className="flex justify-center gap-8">
                    {/* Personal */}
                    <div
                        className="bg-gradient-to-br from-indigo-600 to-indigo-800 text-white rounded-xl shadow-lg p-6 flex flex-col items-center cursor-pointer transform hover:scale-105 transition"
                    ...
                    {/* Educational */}
                    <div
                        className="bg-gradient-to-br from-green-500 to-green-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center cursor-pointer transform hover:scale-105 transition"
                        onClick={handleOptionClick}
                    >
                    ...
                    {/* Professional */}
                    <div
                        className="bg-gradient-to-br from-purple-500 to-purple-700 text-white rounded-xl shadow-lg p-6 flex flex-col items-center cursor-pointer transform hover:scale-105 transition"
                        onClick={handleOptionClick}
                    >
